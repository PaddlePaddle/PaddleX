...
class AnimeGAN(UltraInferModel):
    def __init__(
        ...
        :param params_file: (str)Path of parameters file, e.g ./model.pdiparams, if the model_format is ModelFormat.ONNX, this param will be ignored, can be set as empty string
