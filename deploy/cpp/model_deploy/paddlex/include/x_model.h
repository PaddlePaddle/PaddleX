...
class PaddleXModel : public Model {
 private:
  const std::string model_type;

 public:
  explicit PaddleXModel(const std::string model_type) : model_type(model_type) {
    std::cerr << "init PaddleXModel,model_type=" << model_type << std::endl;
  }
