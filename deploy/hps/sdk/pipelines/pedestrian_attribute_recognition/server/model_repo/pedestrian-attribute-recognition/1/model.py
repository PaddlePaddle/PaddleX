...
class TritonPythonModel(BaseTritonPythonModel):
    def get_input_model_type(self):
        return schemas.pedestrian_attribute_recognition.InferRequest

    def get_result_model_type(self):
        return schemas.pedestrian_attribute_recognition.InferResult
    ...
    def run(self, input, log_id):
        ...
        result = list(
            self.pipeline.predict(
                ...
                cls_threshold=input.clsThreshold,
            )
        )[0]
        ...
        return schemas.pedestrian_attribute_recognition.InferResult(
            pedestrians=pedestrians, image=output_image_base64
        )
