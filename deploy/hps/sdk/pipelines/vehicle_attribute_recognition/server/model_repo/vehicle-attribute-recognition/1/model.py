...
class TritonPythonModel(BaseTritonPythonModel):
    def get_input_model_type(self):
        return schemas.vehicle_attribute_recognition.InferRequest

    def get_result_model_type(self):
        return schemas.vehicle_attribute_recognition.InferResult
    ...
    def run(self, input, log_id):
        ...
        return schemas.vehicle_attribute_recognition.InferResult(
            vehicles=vehicles, image=output_image_base64
        )
