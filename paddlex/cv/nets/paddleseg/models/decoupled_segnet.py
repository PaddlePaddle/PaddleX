...
from paddlex.cv.nets.paddleseg.models.backbones import resnet_vd
from paddlex.cv.nets.paddleseg.models import deeplab
...
class SqueezeBodyEdge(nn.Layer):
    ...
    def flow_warp(self, input, flow, size):
        ...
        norm = paddle.to_tensor(
            np.array([[[[out_w, out_h]]]]), dtype='float32')
