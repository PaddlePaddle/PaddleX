...
# Based on https://github.com/sgl-project/sglang/blob/f4ae50e97ce5be51f6c0b0c5b3fece64987dc089/python/sglang/srt/models/ernie4.py
...
if all(map(is_dep_available, ("torch", "transformers", "sglang"))):
    import torch
