...
from paddlex.inference.components.retrieval.faiss import FaissBuilder
from paddlex.inference.results import FaceRecResult
from paddlex.inference.utils.io import ImageReader
from ..base import BasePipeline


class FaceRecPipeline(BasePipeline):
    ...
    def build_index(
        ...
        **kwargs,
        ...
        self._indexer = FaissIndexer(index_dir, metric_type, 
                                     return_k=self.indexer_kargs['return_k'],
                                     score_thres=self.indexer_kargs['score_thres'],
                                     hamming_radius=self.indexer_kargs['hamming_radius'])
        return
