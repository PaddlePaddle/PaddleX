...
class ChunkConformerPipeline(BasePipeline):
    ...
    entities = "conformer_speech_recognition"
    ...
    def __init__(
        ...
        self.conformer_speech_recognition_model = self.create_model(
            conformer_speech_recognition_model_config
        )
        # only support batch size 1
        batch_size = conformer_speech_recognition_model_config["batch_size"]
