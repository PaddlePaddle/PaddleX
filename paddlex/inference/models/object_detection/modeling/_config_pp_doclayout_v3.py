...
class PPDocLayoutV3Config(PretrainedConfig):
    ...
    def __init__(self, **kwargs):
        ...
        # Mask features (V3-specific)
        self.mask_feature_channels = kwargs.get("mask_feature_channels", [64, 64])
        self.x4_feat_dim = kwargs.get("x4_feat_dim", 128)
        self.num_prototypes = kwargs.get("num_prototypes", 32)
        self.mask_enhanced = kwargs.get("mask_enhanced", True)
        ...
        # Global pointer (reading order)
        self.global_pointer_head_size = kwargs.get("global_pointer_head_size", 64)
        self.gp_dropout_value = kwargs.get("gp_dropout_value", 0.1)
