        ...
        if self._use_local_model:
            ...
            if self.model_name in self.model_group["PaddleOCR-VL"]:
                ...
                if min_pixels is not None:
                    warnings.warn(
                        f"`min_pixels` is currently not supported by the {repr(self.model_name)} and will be ignored."
                    )
                if max_pixels is not None:
                    warnings.warn(
                        f"`max_pixels` is currently not supported by the {repr(self.model_name)} and will be ignored."
                    )
