...
register_model_info({
    ...
    'suite': 'Seg',
    'config_path': osp.join(PDX_CONFIG_DIR, 'SegFormer_B0.yaml'),
    'supported_apis': ['train', 'evaluate', 'predict', 'export', 'infer']
})
...
register_model_info({
    ...
    'suite': 'Seg',
    'config_path': osp.join(PDX_CONFIG_DIR, 'SegFormer_B1.yaml'),
    'supported_apis': ['train', 'evaluate', 'predict', 'export', 'infer']
})
...
register_model_info({
    ...
    'suite': 'Seg',
    'config_path': osp.join(PDX_CONFIG_DIR, 'SegFormer_B2.yaml'),
    'supported_apis': ['train', 'evaluate', 'predict', 'export', 'infer']
})
...
register_model_info({
    ...
    'suite': 'Seg',
    'config_path': osp.join(PDX_CONFIG_DIR, 'SegFormer_B3.yaml'),
    'supported_apis': ['train', 'evaluate', 'predict', 'export', 'infer']
})
...
register_model_info({
    ...
    'suite': 'Seg',
    'config_path': osp.join(PDX_CONFIG_DIR, 'SegFormer_B4.yaml'),
    'supported_apis': ['train', 'evaluate', 'predict', 'export', 'infer']
})
...
register_model_info({
    ...
    'suite': 'Seg',
    'config_path': osp.join(PDX_CONFIG_DIR, 'SegFormer_B5.yaml'),
    'supported_apis': ['train', 'evaluate', 'predict', 'export', 'infer']
})
