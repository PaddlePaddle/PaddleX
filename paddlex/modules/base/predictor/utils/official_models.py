...
Deeplabv3_Plus-R101_infer.tar",
    ...
    "SegFormer_B0":
    "https://paddle-model-ecology.bj.bcebos.com/paddlex/official_inference_model/paddle3.0/SegFormer_B0_infer.tar",
    "SegFormer_B1":
    "https://paddle-model-ecology.bj.bcebos.com/paddlex/official_inference_model/paddle3.0/SegFormer_B1_infer.tar",
    "SegFormer_B2":
    "https://paddle-model-ecology.bj.bcebos.com/paddlex/official_inference_model/paddle3.0/SegFormer_B2_infer.tar",
    "SegFormer_B3":
    "https://paddle-model-ecology.bj.bcebos.com/paddlex/official_inference_model/paddle3.0/SegFormer_B3_infer.tar",
    "SegFormer_B4":
    "https://paddle-model-ecology.bj.bcebos.com/paddlex/official_inference_model/paddle3.0/SegFormer_B4_infer.tar",
    "SegFormer_B5":
    "https://paddle-model-ecology.bj.bcebos.com/paddlex/official_inference_model/paddle3.0/SegFormer_B5_infer.tar",
    "SeaFormer_tiny":
