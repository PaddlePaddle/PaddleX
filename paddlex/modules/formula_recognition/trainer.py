...
class FormulaRecTrainer(BaseTrainer):
    ...
    def build_deamon(self, config: AttrDict) -> "FormulaRecTrainDeamon":
        ...
        Returns:
            FormulaRecTrainDeamon: the training deamon thread object for saving training outputs timely.
        """
        return FormulaRecTrainDeamon(config)
...
class FormulaRecTrainDeamon(BaseTrainDeamon):
    """ TableRecTrainDeamon """
