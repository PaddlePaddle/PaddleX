...
class FormulaRecPredictor(BasePredictor):
    ...
    def _get_post_transforms_from_config(self):
        ...
        tokenizer_path = os.path.abspath("paddlex/modules/formula_recognition/predictor/latex_ocr_tokenizer.json")
        post_transforms = [
            T.LaTeXOCRDecode(tokenizer_path ), T.PrintResult()
        ]
