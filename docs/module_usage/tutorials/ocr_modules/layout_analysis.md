...
版面分析模块可以集成到PaddleX的[文档解析产线（PaddleOCR-VL 系列，含 PaddleOCR-VL-1.5 与 PaddleOCR-VL-1.6）](../../../pipeline_usage/tutorials/ocr_pipelines/PaddleOCR-VL.md)等产线中，只需要替换模型路径即可完成版面分析模块的模型更新。
