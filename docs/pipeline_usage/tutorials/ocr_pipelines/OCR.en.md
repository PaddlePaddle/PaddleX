...
* Test data:
    * [test_data_OCR.tar](https://paddle-model-ecology.bj.bcebos.com/paddlex/PaddleX3.0/pipeline_infer_bench/input_data/test_data_OCR.tar), which contains 200 images from document and general scenarios.
* Test strategy:
