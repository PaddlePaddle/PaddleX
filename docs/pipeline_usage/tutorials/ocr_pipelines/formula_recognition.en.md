...
<b>Note: The model's accuracy metrics are measured on the <a href="https://www3.cs.stonybrook.edu/~cvl/docunet.html">DocUNet benchmark</a>.</b>
...
<td>1454.27</td>
<td>123.76 M</td>
<td>A high-precision layout detection model based on RT-DETR-L, trained on a self-built dataset containing Chinese and English papers, magazines, contracts, books, exams, and research reports.</td>
</tr>
<tr>
...
<td>160.1</td>
<td>22.578</td>
<td>A layout detection model with balanced precision and efficiency based on PicoDet-L, trained on a self-built dataset containing Chinese and English papers, magazines, contracts, books, exams, and research reports.</td>
</tr>
<tr>
...
<td>46.7</td>
<td>4.834</td>
<td>A high-efficiency layout detection model based on PicoDet-S, trained on a self-built dataset containing Chinese and English papers, magazines, contracts, books, exams, and research reports.</td>
</tr>
</tbody>
</table>

<b>Note: The accuracy metrics are evaluated on a self-built layout detection dataset by PaddleOCR, containing 500 common document-type images of Chinese and English papers, magazines, contracts, books, exams, and research reports. GPU inference time is based on an NVIDIA Tesla T4 machine, with FP32 precision. CPU inference speed is based on an Intel(R) Xeon(R) Gold 5117 CPU @ 2.00GHz, with 8 threads and FP32 precision.</b>

> ❗ The above list includes the <b>3 core models</b> supported by the layout detection module. The module supports a total of <b>11 models</b>, including multiple predefined models with different categories. The complete list of models is as follows:
...
<tbody>
<tr>
<td>PicoDet_layout_1x_table</td><td><a href="<url id="" type="url" status="" title="" wc="">https://paddle-model-ecology.bj.bcebos.com/paddlex/official_inference_model/paddle3.0rc0/PicoDet_layout_1x_table_infer.tar">Inference Model</a>/<a</url>  href="<url id="" type="url" status="" title="" wc="">https://paddle-model-ecology.bj.bcebos.com/paddlex/official_pretrained_model/PicoDet_layout_1x_table_pretrained.pdparams">Pre-trained Model</a></td></url>
<td>97.5</td>
<td>12.623</td>
<td>90.8934</td>
<td>7.4 M</td>
<td>High-efficiency layout region localization model trained on a self-built dataset based on PicoDet-1x, capable of locating table regions</td>
</tr>
</table>

<b>Note: The evaluation dataset for the above accuracy metrics is the self-built layout table region detection dataset of PaddleOCR, which includes 7835 images of paper documents with tables in both Chinese and English. GPU inference time is based on NVIDIA Tesla T4 machine, precision type is FP32, and CPU inference speed is based on Intel(R) Xeon(R) Gold 5117 CPU @ 2.00GHz, with 8 threads, precision type is FP32.</b>
...
<tbody>
<tr>
<td>PicoDet-S_layout_3cls</td><td><a href="<url id="" type="url" status="" title="" wc="">https://paddle-model-ecology.bj.bcebos.com/paddlex/official_inference_model/paddle3.0rc0/PicoDet-S_layout_3cls_infer.tar">Inference Model</a>/<a</url>  href="<url id="" type="url" status="" title="" wc="">https://paddle-model-ecology.bj.bcebos.com/paddlex/official_pretrained_model/PicoDet-S_layout_3cls_pretrained.pdparams">Pre-trained Model</a></td></url>
<td>88.2</td>
<td>13.5</td>
<td>45.8</td>
<td>4.8</td>
<td>High-efficiency layout region localization model trained on a self-built dataset based on PicoDet-S lightweight model in scenarios such as Chinese and English papers, magazines, and research reports</td>
</tr>
<tr>
<td>PicoDet-L_layout_3cls</td><td><a href="<url id="" type="url" status="" title="" wc="">https://paddle-model-ecology.bj.bcebos.com/paddlex/official_inference_model/paddle3.0rc0/PicoDet-L_layout_3cls_infer.tar">Inference Model</a>/<a</url>  href="<url id="" type="url" status="" title="" wc="">https://paddle-model-ecology.bj.bcebos.com/paddlex/official_pretrained_model/PicoDet-L_layout_3cls_pretrained.pdparams">Pre-trained Model</a></td></url>
<td>89.0</td>
<td>15.7</td>
<td>159.8</td>
<td>22.6</td>
<td>Efficiency and accuracy balanced layout region localization model trained on a self-built dataset based on PicoDet-L in scenarios such as Chinese and English papers, magazines, and research reports</td>
</tr>
<tr>
<td>RT-DETR-H_layout_3cls</td><td><a href="<url id="" type="url" status="" title="" wc="">https://paddle-model-ecology.bj.bcebos.com/paddlex/official_inference_model/paddle3.0rc0/RT-DETR-H_layout_3cls_infer.tar">Inference Model</a>/<a</url>  href="<url id="" type="url" status="" title="" wc="">https://paddle-model-ecology.bj.bcebos.com/paddlex/official_pretrained_model/RT-DETR-H_layout_3cls_pretrained.pdparams">Pre-trained Model</a></td></url>
<td>95.8</td>
<td>114.6</td>
<td>3832.6</td>
<td>470.1</td>
<td>High-accuracy layout region localization model trained on a self-built dataset based on RT-DETR-H in scenarios such as Chinese and English papers, magazines, and research reports</td>
</tr>
</table>

<b>Note: The evaluation dataset for the above accuracy metrics is the self-built layout region detection dataset of PaddleOCR, which includes 1154 common document images of Chinese and English papers, magazines, and research reports. GPU inference time is based on NVIDIA Tesla T4 machine, precision type is FP32, and CPU inference speed is based on Intel(R) Xeon(R) Gold 5117 CPU @ 2.00GHz, with 8 threads, precision type is FP32.</b>

* <b>5-category English Document Layout Detection Model, including text, title, table, image, and list</b>
...
<b>Note: The evaluation set for the above accuracy metrics is the [PubLayNet](https://developer.ibm.com/exchanges/data/all/publaynet/) evaluation dataset, which includes 11,245 images of English documents. The GPU inference time is based on an NVIDIA Tesla T4 machine with FP32 precision. The CPU inference speed is based on an Intel(R) Xeon(R) Gold 5117 CPU @ 2.00GHz with 8 threads and FP32 precision.</b>

* <b>17-category Layout Detection Model, including 17 common layout categories: paragraph title, image, text, number, abstract, content, figure title, formula, table, table title, reference, document title, footnote, header, algorithm, footer, seal</b>
...
<td>UniMERNet</td><td><a href="<url id="" type="url" status="" title="" wc="">https://paddle-model-ecology.bj.bcebos.com/paddlex/official_inference_model/paddle3.0rc0/UniMERNet_infer.tar">Inference Model</a>/<a</url>  href="<url id="" type="url" status="" title="" wc="">https://paddle-model-ecology.bj.bcebos.com/paddlex/official_pretrained_model/UniMERNet_pretrained.pdparams">Training Model</a></td></url>
<td>0.8613</td>
<td>2266.96</td>
<td>1.4 G</td>
<td>UniMERNet is a formula recognition model developed by Shanghai AI Lab. This model uses Donut Swin as the encoder and MBartDecoder as the decoder. It has been trained on a dataset of one million data points, including simple formulas, complex formulas, scanned formulas, and handwritten formulas, significantly improving the model's accuracy in recognizing formulas in real-world scenarios.</td>
<tr>
<td>PP-FormulaNet-S</td><td><a href="<url id="" type="url" status="" title="" wc="">https://paddle-model-ecology.bj.bcebos.com/paddlex/official_inference_model/paddle3.0rc0/PP-FormulaNet-S_infer.tar">Inference Model</a>/<a</url>  href="<url id="" type="url" status="" title="" wc="">https://paddle-model-ecology.bj.bcebos.com/paddlex/official_pretrained_model/PP-FormulaNet-S_pretrained.pdparams">Training Model</a></td></url>
<td>0.8712</td>
<td>202.25</td>
<td>167.9 M</td>
<td rowspan="2">PP-FormulaNet is an advanced formula recognition model developed by Baidu PaddlePaddle Vision Team, supporting the recognition of 50,000 common LaTeX source code words. The PP-FormulaNet-S version uses PP-HGNetV2-B4 as its backbone network, significantly improving the model's inference speed through techniques such as parallel masking and model distillation, while maintaining high recognition accuracy. It is suitable for scenarios such as simple printed formulas and cross-line simple printed formulas. The PP-FormulaNet-L version, based on Vary_VIT_B as the backbone network, has undergone extensive training on a large-scale formula dataset, showing significant improvement in recognizing complex formulas compared to PP-FormulaNet-S. It is suitable for scenarios such as simple printed formulas, complex printed formulas, and handwritten formulas.</td>
</tr>
<td>PP-FormulaNet-L</td><td><a href="<url id="" type="url" status="" title="" wc="">https://paddle-model-ecology.bj.bcebos.com/paddlex/official_inference_model/paddle3.0rc0/PP-FormulaNet-L_infer.tar">Inference Model</a>/<a</url>  href="<url id="" type="url" status="" title="" wc="">https://paddle-model-ecology.bj.bcebos.com/paddlex/official_pretrained_model/PP-FormulaNet-L_pretrained.pdparams">Training Model</a></td></url>
<td>0.9213</td>
<td>1976.52</td>
<td>535.2 M</td>
<tr>
<td>LaTeX_OCR_rec</td><td><a href="<url id="" type="url" status="" title="" wc="">https://paddle-model-ecology.bj.bcebos.com/paddlex/official_inference_model/paddle3.0rc0/LaTeX_OCR_rec_infer.tar">Inference Model</a>/<a</url>  href="<url id="" type="url" status="" title="" wc="">https://paddle-model-ecology.bj.bcebos.com/paddlex/official_pretrained_model/LaTeX_OCR_rec_pretrained.pdparams">Training Model</a></td></url>
<td>0.7163</td>
=======
