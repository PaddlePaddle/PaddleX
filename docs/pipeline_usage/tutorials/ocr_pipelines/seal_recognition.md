...
* 测试数据：
    * [test_data_seal_recognition.tar](https://paddle-model-ecology.bj.bcebos.com/paddlex/PaddleX3.0/pipeline_infer_bench/input_data/test_data_seal_recognition.tar)，其中包含130张印章图像。
* 测试策略：
