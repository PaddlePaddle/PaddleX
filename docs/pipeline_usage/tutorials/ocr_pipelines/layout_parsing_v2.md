...
from paddlex import create_pipeline
from paddlex.inference.pipelines.layout_parsing.utils import concatenate_markdown_pages
...
markdown_texts,markdown_images = concatenate_markdown_pages(layout_parsing_pipeline_output=output)
