...
如需手动打包可参考 [`hps` 项目文档](https://github.com/PaddlePaddle/PaddleX/blob/release/3.1/deploy/hps/README.md#2-产线物料打包)。
...
如需自定义构建镜像可参考 [`hps` 项目文档](https://github.com/PaddlePaddle/PaddleX/blob/release/3.1/deploy/hps/README.md#1-镜像构建)。
