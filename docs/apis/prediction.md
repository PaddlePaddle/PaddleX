...
```
- YOLOv3模型predict接口[说明文档](./models/detection.md#predict)
...
```
- MaskRCNN模型predict接口[说明文档](./models/instance_segmentation.md#predict)
- 可视化pdx.det.visualize接口[说明文档](https://github.com/PaddlePaddle/PaddleX/blob/develop/paddlex/cv/models/utils/visualize.py#L25)
...
- DeepLabv3模型predict接口[说明文档](./models/semantic_segmentation.md#predict)
