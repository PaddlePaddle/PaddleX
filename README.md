...
- **数据准备**：支持[EasyData智能数据服务平台](https://ai.baidu.com/easydata/)，可便捷完成智能标注,低质数据清洗工作。同时兼容ImageNet、VOC、COCO多种数据协议, 助力开发者更快完成数据准备工作。
...
- **Python开发模式：** 通过Python API方式完成全流程使用或集成，该模式提供全面、灵活、开放的深度学习开发体验，有更高的定制化空间。
...
```
安装的相关问题参考[PaddleX 安装](https://paddlex.readthedocs.io/zh_CN/latest/install.html)
