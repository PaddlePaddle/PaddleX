...
- 时间 全新发布Manufacture SDK，提供工业级多端多平台部署加速的预编译飞桨部署开发包（SDK），通过配置业务逻辑流程文件即可以低代码方式快速完成推理部署。[欢迎体验](./deploy/cpp/docs/manufacture_sdk)
...
- [部署方式概览]()
  ...
  - [本地部署]()
    ...
    - [C++部署]()
      ...
      - [Deployment SDK](./deploy/cpp) : [WinC#-Demo](./examples/C%23_deploy)  |  [LinuxQT-Demo]()
