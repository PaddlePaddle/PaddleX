...
import os
from pdf_to_md_to_word import md_to_word,json_to_html_with_headfoot

input_path = "PaddleX/OSPP__toWord/document_sample.pdf"
output_path = "PaddleX/OSPP__toWord/output"
...
with open(f"{output_path}/{base_name}_en.md", "r", encoding="utf-8") as f:
    md_text = f.read()
md_to_word(md_text, output_path, base_name)